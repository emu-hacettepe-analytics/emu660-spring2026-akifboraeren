# ==============================================================================
# Script: clustering_analysis.R
# Purpose: K-Means Clustering for Airport Segmentation (2025 Data)
# ==============================================================================
...
df_kmeans_prep <- pass_2025 |>
  ...
  mutate(city_match = sub(" .*$", "", toupper(airport))) |>
  left_join(
    population |> 
      # ????te kesin ????z??m buras??: ??simlere bakmadan 1. ve 2. s??tunu al??yor
      select(city = 1, pop_2025 = 2) |> 
